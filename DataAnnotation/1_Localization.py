...
def check_contour_boundary(contour, w, h): # check criteria for boundary cell (a part of irrelevant cells)
...
class cellPlate: # managing folders for source and target 
    def __init__(self, navigation, navigation_cp):
        ...
        self.localize_path = os.path.join("r", self.root_path, "data_IP/output_localize", self.navigation)
        self.image_path = os.path.join("r", self.root_path, "data_IP/output_image", self.navigation)
        self.segment1_path = os.path.join("r", self.root_path, "data_IP/output_segment1", self.navigation)
        self.segment3_path = os.path.join("r", self.root_path, "data_IP/output_segment3", self.navigation)
        self.coco_path = os.path.join("r", self.root_path, "data_IP/output_coco", self.navigation)
        self.properties_path = os.path.join("r", self.root_path, "data_IP/output_properties", self.navigation)
...
if __name__ == "__main__":
    ...
    navigation = 'S1/Plate_07/Scramble' 
    navigation_cp = 'S1/Plate_07/Scramble'
